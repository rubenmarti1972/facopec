...
/**
 * Actualizar SOLO Home Page con los arrays faltantes
 * Saltamos Global Settings que está causando problemas
 */
...
async function main() {
  ...
  try {
    ...
    await updateHomePageOnly();
    console.log('✅ Home Page actualizado completamente\n');
